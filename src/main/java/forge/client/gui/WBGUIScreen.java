...
public class WBGUIScreen extends AbstractContainerScreen<WBGUIMenu> {
	private final static HashMap<String, Object> guistate = WBGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public WBGUIScreen(WBGUIMenu container, Inventory inventory, Component text) {
