package forge.world.features.treedecorators;
...
public class HeavenBIOFruitDecorator extends CocoaDecorator {
	public static final HeavenBIOFruitDecorator INSTANCE = new HeavenBIOFruitDecorator();
	public static com.mojang.serialization.Codec<HeavenBIOFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("heaven_bio_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public HeavenBIOFruitDecorator() {
		super(0.2f);
	}
