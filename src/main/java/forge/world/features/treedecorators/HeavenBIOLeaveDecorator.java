...
public class HeavenBIOLeaveDecorator extends LeaveVineDecorator {
	public static final HeavenBIOLeaveDecorator INSTANCE = new HeavenBIOLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("heaven_bio_tree_leave_decorator");
