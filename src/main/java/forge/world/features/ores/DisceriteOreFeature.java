...
public class DisceriteOreFeature extends OreFeature {
	...
	private static class DisceriteOreFeatureRuleTest extends RuleTest {
		static final DisceriteOreFeatureRuleTest INSTANCE = new DisceriteOreFeatureRuleTest();
		private static final com.mojang.serialization.Codec<DisceriteOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<DisceriteOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;
