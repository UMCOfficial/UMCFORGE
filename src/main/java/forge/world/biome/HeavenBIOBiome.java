...
public class HeavenBIOBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-1).waterColor(-6145).waterFogColor(-6145).skyColor(-1)
