...
public class BreadEssenceItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Used to make bread or dead"));
		list.add(new TextComponent("its also a very good food source"));
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		BreadEssenceRightclickedProcedure.execute(world, x, y, z);
		return ar;
	}
}
