...
public abstract class HeaveniteArmorItem extends ArmorItem {
	public HeaveniteArmorItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDurabilityForSlot(EquipmentSlot slot) {
				return new int[]{13, 15, 16, 11}[slot.getIndex()] * 63;
			}

			@Override
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{8, 25, 21, 8}[slot.getIndex()];
			}
	...
	public static class Helmet extends HeaveniteArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends HeaveniteArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends HeaveniteArmorItem {
		public Leggings() {
	...
	public static class Boots extends HeaveniteArmorItem {
		public Boots() {
