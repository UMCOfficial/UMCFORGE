...
import forge.item.inventory.DiscBenchOnAStickInventoryCapability;

import forge.init.UmcforgeModTabs;

public class DiscBenchOnAStickItem extends Item {
	public DiscBenchOnAStickItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Disc Bench But On A Stick"));
	}
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return new TextComponent("Disc Bench On A Stick");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new BenchMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new DiscBenchOnAStickInventoryCapability();
	}
