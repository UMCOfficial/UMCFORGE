	...
	public static void load() {
		TAB_UMC_DISCS = new CreativeModeTab("tabumc_discs") {
			...
			public ItemStack makeIcon() {
				return new ItemStack(UmccoreModItems.FIRST_HOUR.get());
			}
		...
		TAB_UMC_FRAGMENTS = new CreativeModeTab("tabumc_fragments") {
			@Override
			public ItemStack makeIcon() {
				return new ItemStack(UmccoreModItems.FIRST_FRAGMENT.get());
			}
		...
		TAB_UMC_ESSENCES = new CreativeModeTab("tabumc_essences") {
			@Override
			public ItemStack makeIcon() {
				return new ItemStack(UmccoreModItems.BLANK_ESSENCE.get());
			}
		...
		TAB_UMC_SPECIAL = new CreativeModeTab("tabumc_special") {
			@Override
			public ItemStack makeIcon() {
				return new ItemStack(UmccoreModItems.DISCERITE.get());
			}
		...
		TAB_UMC_BIOMES = new CreativeModeTab("tabumc_biomes") {
			@Override
			public ItemStack makeIcon() {
				return new ItemStack(UmccoreModItems.UNAVAILABLE_1.get());
			}
